...
new g_poolTableData 				[ MAX_POOL_TABLES ] [ E_POOL_TABLE_DATA ], g_poolBallData 					[ MAX_POOL_TABLES ] [ E_POOL_BALL_DATA ], p_PoolID 						[ MAX_PLAYERS ] = { -1, ... };
new	bool: p_isPlayingPool			[ MAX_PLAYERS char ];
new	bool: p_PoolChalking			[ MAX_PLAYERS char ];
new	bool: p_PoolCameraBirdsEye		[ MAX_PLAYERS char ];
new	p_PoolScore 					[ MAX_PLAYERS ];
new	p_PoolHoleGuide 				[ MAX_PLAYERS ] = { -1, ... };
new	Float: p_PoolAngle 				[ MAX_PLAYERS ] [ 2 ];
new	PlayerBar: g_PoolPowerBar 		[ MAX_PLAYERS ];
new	Text: g_PoolTextdraw			= Text: INVALID_TEXT_DRAW;
new	Iterator: pooltables 			< MAX_POOL_TABLES >;
new Iterator: poolplayers 			< MAX_POOL_TABLES, MAX_PLAYERS >;
